...
test("suggestion mode: add row", async () => {
  ...
  sync();
  await expect
    .element(screen.getByTestId("editor-A").getByText("A1"))
    .toBeVisible();
  ...
  await expect
    .element(screen.getByTestId("editor-A").getByText("A3"))
    .toBeVisible();
...
test("suggestion mode: add column", async () => {
  ...
  await expect
    .element(screen.getByTestId("editor-A").getByText("C1"))
    .toBeVisible();
...
test("suggestion mode: remove row", async () => {
  ...
  sync();
  await expect
    .element(screen.getByTestId("editor-A").getByText("A2"))
    .toBeVisible();
...
test("suggestion mode: remove column", async () => {
  ...
  sync();
  await expect
    .element(screen.getByTestId("editor-A").getByText("B1"))
    .toBeVisible();
...
test("suggestion mode: update text in cell", async () => {
  ...
  await expect
    .element(screen.getByTestId("editor-A").getByText("edited"))
    .toBeVisible();
...
test("suggestion mode: split a merged cell", async () => {
  ...
  sync();
  await expect
    .element(screen.getByTestId("editor-A").getByText("A1+B1"))
    .toBeVisible();

...
import { testExportDocX } from "../../../testTypes/formatConversion/export/textExecutors/testExportDocX.js";
import { testExportDocXOptions } from "../../../testTypes/formatConversion/export/textExecutors/testExportDocXOptions.js";
...
export const exportTestInstancesDocX: TestInstance<
...
>[] = [
  ...
  console.log("Hello World", message);
    ...
    executeTest: testExportDocX,
  },
];

export const exportTestInstancesDocXOptions: TestInstance<
  ExportTestCase<TestBlockSchema, TestInlineContentSchema, TestStyleSchema>,
  TestBlockSchema,
  TestInlineContentSchema,
  TestStyleSchema
>[] = exportTestInstancesDocX.map(({ testCase }) => ({
  testCase,
  executeTest: testExportDocXOptions,
}));

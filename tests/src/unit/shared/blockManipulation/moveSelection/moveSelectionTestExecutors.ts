...
import { MoveSelectionTestCase } from "./moveSelectionTestCase.js";

export const testMoveSelectionStart = async <
  B extends BlockSchema,
  I extends InlineContentSchema,
  S extends StyleSchema,
>(
  editor: BlockNoteEditor<B, I, S>,
  testCase: MoveSelectionTestCase<B, I, S>,
) => {
...
export const testMoveSelectionEnd = async <
  B extends BlockSchema,
  I extends InlineContentSchema,
  S extends StyleSchema,
>(

...
import { htmlDocumentLLMFormat } from "./htmlDocument.js";
  ...
  for (const params of testMatrix) {
    describe(`${params.model.provider}/${params.model.modelId} (${
      ...
      generateSharedTestCases({
        streamToolsProvider: htmlDocumentLLMFormat.getStreamToolsProvider({
          withDelays: false,
        }),
        documentStateBuilder:
          htmlDocumentLLMFormat.defaultDocumentStateBuilder as any,
        transport: new ClientSideTransport({
          systemPrompt: htmlDocumentLLMFormat.systemPrompt,
          model: params.model,

...
import { tsxDocumentLLMFormat } from "./tsxDocument.js";
  ...
  for (const params of testMatrix) {
    describe(`${params.model.provider}/${params.model.modelId} (${
      ...
      generateSharedTestCases({
        streamToolsProvider: tsxDocumentLLMFormat.getStreamToolsProvider({
          withDelays: false,
        }),
        documentStateBuilder: tsxDocumentLLMFormat.defaultDocumentStateBuilder,
        transport: new ClientSideTransport({
          systemPrompt: tsxDocumentLLMFormat.systemPrompt,
          model: params.model,

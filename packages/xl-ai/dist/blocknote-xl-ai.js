...
import $, { createContext as er, useContext as tr, useState as te, useCallback as re, useMemo as Ee, useEffect as ct } from "react";
import { useBlockNoteEditor as oe, useBlockNoteContext as rr, useComponentsContext as ut, useSuggestionMenuKeyboardHandler as nr, useUIElementPositioning as ir } from "@blocknote/react";
...
import tt from "remark-parse";
import { unified as Ae } from "unified";
import { SequenceMatcher as gr } from "@ewoudenberg/difflib";
import hr from "remark-stringify";
import { offset as yr, flip as br, size as _r, autoUpdate as vr } from "@floating-ui/react";
import { PluginKey as pt, Plugin as ft } from "prosemirror-state";
import { Decoration as kr, DecorationSet as wr } from "prosemirror-view";
const Cr = (t, e) => async (n, i) => {
...
function xr() {
  ...
  function s(u, c, f) {
    var d, b = {}, v = null, I = null;
    f !== void 0 && (v = "" + f), c.key !== void 0 && (v = "" + c.key), c.ref !== void 0 && (I = c.ref);
    for (d in c) i.call(c, d) && !a.hasOwnProperty(d) && (b[d] = c[d]);
    if (u && u.defaultProps) for (d in c = u.defaultProps, c) b[d] === void 0 && (b[d] = c[d]);
    return { $$typeof: e, type: u, key: v, ref: I, props: b, _owner: o.current };
  }
...
function Ir() {
  return nt || (nt = 1, process.env.NODE_ENV !== "production" && function() {
    var t = $, e = Symbol.for("react.element"), n = Symbol.for("react.portal"), i = Symbol.for("react.fragment"), o = Symbol.for("react.strict_mode"), a = Symbol.for("react.profiler"), s = Symbol.for("react.provider"), u = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), f = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), v = Symbol.for("react.lazy"), I = Symbol.for("react.offscreen"), y = Symbol.iterator, m = "@@iterator";
    function h(r) {
    ...
    function G(r, l, p) {
      {
        ...
        w !== "" && (l += "%s", p = p.concat([w]));
        var C = p.map(function(k) {
          return String(k);
        });
        C.unshift("Warning: " + l), Function.prototype.apply.call(console[r], console, C);
      }
    }
    var K = !1, q = !1, Y = !1, H = !1, R = !1, P;
    P = Symbol.for("react.module.reference");
    function M(r) {
      return !!(typeof r == "string" || typeof r == "function" || r === i || r === a || R || r === o || r === f || r === d || H || r === I || K || q || Y || typeof r == "object" && r !== null && (r.$$typeof === v || r.$$typeof === b || r.$$typeof === s || r.$$typeof === u || r.$$typeof === c || // This needs to include all possible module reference object
    ...
    function D(r) {
      ...
      if (typeof r == "object")
        switch (r.$$typeof) {
          ...
          case v: {
            var w = r, C = w._payload, k = w._init;
            try {
              return D(k(C));
            } catch {
              return null;
    ...
    var z = Object.assign, Z = 0, Be, Le, Te, Me, De, Ue, Ne;
    function $e() {
    }
    ...
    function It() {
      {
        if (Z === 0) {
          Be = console.log, Le = console.info, Te = console.warn, Me = console.error, De = console.group, Ue = console.groupCollapsed, Ne = console.groupEnd;
          var r = {
            configurable: !0,
            enumerable: !0,
            value: $e,
...
` + ye + r;
    ...
    function ze(r, l) {
      ...
      var C;
      C = he.current, he.current = null, It();
      try {
        if (l) {
          var k = function() {
            throw Error();
        ...
        if (B && g && typeof B.stack == "string") {
          for (var _ = B.stack.split(`
`), j = g.stack.split(`
`), A = _.length - 1, E = j.length - 1; A >= 1 && E >= 0 && _[A] !== j[E]; )
            E--;
          for (; A >= 1 && E >= 0; A--, E--)
            if (_[A] !== j[E]) {
              if (A !== 1 || E !== 1)
...
` + _[A].replace(" at new ", " at ");
                    return r.displayName && T.includes("<anonymous>") && (T = T.replace("<anonymous>", r.displayName)), typeof r == "function" && le.set(r, T), T;
                  }
                while (A >= 1 && E >= 0);
              break;
            }
        ...
        be = !1, he.current = C, At(), Error.prepareStackTrace = w;
      }
    ...
    var J = Object.prototype.hasOwnProperty, Fe = {}, Ge = O.ReactDebugCurrentFrame;
    function ue(r) {
      if (r) {
        var l = r._owner, p = ce(r.type, r._source, l ? l.type : null);
        Ge.setExtraStackFrame(p);
      } else
        Ge.setExtraStackFrame(null);
    }
    function Rt(r, l, p, g, w) {
      {
          ...
          if (C(r, k)) {
            ...
            try {
              if (typeof r[k] != "function") {
                var j = Error((g || "React class") + ": " + p + " type `" + k + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof r[k] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw j.name = "Invariant Violation", j;
              }
              _ = r[k](l, k, g, p, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (A) {
              _ = A;
            }
            _ && !(_ instanceof Error) && (ue(w), S("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", g || "React class", p, k, typeof _), ue(null)), _ instanceof Error && !(_.message in Fe) && (Fe[_.message] = !0, ue(w), S("Failed %s type: %s", p, _.message), ue(null));
          }
      }
    }
    ...
    function He(r) {
      if (Bt(r))
        return S("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", jt(r)), qe(r);
    }
    ...
    function Dt(r, l) {
      if (typeof r.ref == "string" && X.current && l && X.current.stateNode !== l) {
        var p = D(X.current.type);
        ve[p] || (S('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', D(X.current.type), r.ref), ve[p] = !0);
      }
    }
    function Ut(r, l) {
      {
        var p = function() {
          We || (We = !0, S("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", l));
        };
    ...
    function Nt(r, l) {
      {
        var p = function() {
          Ve || (Ve = !0, S("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", l));
        };
    ...
    function zt(r, l, p, g, w) {
      {
        var C, k = {}, _ = null, j = null;
        p !== void 0 && (He(p), _ = "" + p), Mt(l) && (He(l.key), _ = "" + l.key), Tt(l) && (j = l.ref, Dt(l, w));
        for (C in l)
          J.call(l, C) && !Lt.hasOwnProperty(C) && (k[C] = l[C]);
        if (r && r.defaultProps) {
        ...
        return $t(r, _, j, w, g, X.current, k);
      }
    }
    var ke = O.ReactCurrentOwner, Ke = O.ReactDebugCurrentFrame;
    function W(r) {
      if (r) {
        var l = r._owner, p = ce(r.type, r._source, l ? l.type : null);
    ...
    function Je(r, l) {
      {
        ...
        Ze[p] = !0;
        var g = "";
        r && r._owner && r._owner !== ke.current && (g = " It was passed a child from " + D(r._owner.type) + "."), W(r), S('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', p, g), W(null);
      }
    }
    function Xe(r, l) {
      {
        ...
        if (_e(r))
          ...
          if (typeof w == "function" && w !== r.entries)
            for (var C = w.call(r), k; !(k = C.next()).done; )
              Ce(k.value) && Je(k.value, l);
        }
      }
    }
    function qt(r) {
    ...
    function Ht(r) {
      {
        for (var l = Object.keys(r.props), p = 0; p < l.length; p++) {
          var g = l[p];
          if (g !== "children" && g !== "key") {
            W(r), S("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", g), W(null);
            break;
          }
        }
    ...
    function et(r, l, p, g, w, C) {
      {
        ...
        if (!k) {
          ...
          j ? _ += j : _ += Ye();
          var A;
          r === null ? A = "null" : _e(r) ? A = "array" : r !== void 0 && r.$$typeof === e ? (A = "<" + (D(r.type) || "Unknown") + " />", _ = " Did you accidentally export a JSX literal instead of a component?") : A = typeof r, S("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", A, _);
        }
        var E = zt(r, l, p, w, C);
        if (E == null)
          return E;
        ...
        if (J.call(l, "key")) {
          var F = D(r), B = Object.keys(l).filter(function(Jt) {
            return Jt !== "key";
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, xe, F, Zt, F), Qe[F + xe] = !0;
          }
        }
        return r === i ? Ht(E) : qt(E), E;
      }
    }
    function Wt(r, l, p) {
      return et(r, l, p, !0);
    ...
    var Kt = Vt, Yt = Wt;
    ee.Fragment = i, ee.jsx = Kt, ee.jsxs = Yt;
  }()), ee;
}
process.env.NODE_ENV === "production" ? Se.exports = xr() : Se.exports = Ir();
var x = Se.exports;
...
function Er(t, e, n, i) {
  ...
  for (let c = 0; c < s.length; c++)
    e.updateBlock(a[c], s[c]);
  const u = t.blocks.slice(a.length);
  if (u.length > 0) {
    if (s.length === 0)
      return [...e.insertBlocks(u, o, t.position).map((d) => d.id)];
    const c = e.insertBlocks(
      u,
      a[a.length - 1],
      "after"
    );
    return {
      operationContext: [...a, ...c.map((f) => f.id)],
      lastAffectedBlockId: c[c.length - 1]
    };
  }
  return {
    operationContext: a,
...
function Or(t, e, n) {
  if (t.type !== mt.name || t.position !== "before" && t.position !== "after")
    return !1;
  let i = t.referenceId;
  if (n.idsSuffixed) {
...
function Br(t, e, n) {
  ...
  return o ? dt(t.block, e, o.type) : (console.error("BLOCK NOT FOUND", i), !1);
}
const ie = {
  schema: yt,
  apply: jr,
...
function Lr(t) {
  return [
    ...
    {
      role: "system",
      content: JSON.stringify(bt(t.document))
    },
    {
      role: "system",
...
function Fr(t) {
  return t = Gr(t).removeFileBlocks().removeDefaultProps().get(), {
    $defs: {
      styles: Ur(t.styleSchema),
      styledtext: Nr(),
      inlinecontent: $r(
        t.inlineContentSchema
      ),
      block: zr(t.blockSchema)
    }
  };
}
function Gr(t) {
...
async function qr(t, e) {
  const { prompt: n, ...i } = e, o = {
    functions: [ie, ne, ht],
    stream: !0,
    messages: "messages" in e && e.messages !== void 0 ? e.messages : Lr({
      editor: t,
      userPrompt: e.prompt,
      document: t.document
    }),
  ...
  if (o.stream) {
    const u = ar({
      ...
      schema: a,
      messages: o.messages,
      ...o._streamObjectOptions
    });
    return await Ar(
      t,
      u.partialObjectStream,
      o.functions
    ), u;
  }
  const s = await sr({
    ...
    schema: a,
    messages: o.messages,
    ...o._generateObjectOptions
  });
  if (!s.object.operations)
    throw new Error("No operations returned");
  for (const u of s.object.operations)
    await Oe(u, t, o.functions, void 0, {
      idsSuffixed: !0
...
async function Hr(t, e) {
  const n = Ae().use(tt).parse(t), i = Ae().use(tt).parse(e), o = mr.diffChars(t, e), a = [];
  let s = 0, u = 0;
  const c = [...it(n.children)], f = [...it(i.children)], d = /* @__PURE__ */ new Map();
  for (const b of o) {
    let v = s, I = u;
    if (b.added ? I = u + b.value.length : b.removed ? v = s + b.value.length : (v = s + b.value.length, I = u + b.value.length), !b.added) {
      for (const y of c)
        if (y.position.start.offset < v && y.position.end.offset > s)
          d.set(y, [...d.get(y) || [], b]);
        else if (y.position.start.offset > v)
          break;
    }
    if (!b.removed) {
      for (const y of f)
  ...
  for (const b of o) {
    if (b.added) {
      const y = pe(
        f,
        (m) => d.get(m).some((h) => h === b) && d.get(m).length === 1
    ...
    const v = pe(
      f,
      (y) => d.get(y).some((m) => m === b)
    ), I = pe(
      c,
      (y) => d.get(y).some((m) => b === m)
    );
    for (; v.length || I.length; ) {
      const y = v.shift(), m = I.shift();
      if (!y && !m)
        throw new Error("No matching blocks found");
      y ? m ? d.get(m).every((h) => !h.added && !h.removed) && d.get(y).every((h) => !h.added && !h.removed) ? a.push({ type: "unchanged", newBlock: y, oldBlock: m }) : a.push({ type: "changed", newBlock: y, oldBlock: m }) : a.push({ type: "add", newBlock: y }) : a.push({ type: "remove", oldBlock: m });
    }
  }
  return a;
}
...
class Wr {
  ...
  objectDiff(e, n) {
    ...
    for (const [s, u] of Object.entries(e))
      if (!this.options.outputNewOnly) {
        const c = "__deleted";
        !(s in n) && !this.options.excludeKeys.includes(s) && (i[`${s}${c}`] = u, o -= 30, a = !1);
      }
    for (const [s, u] of Object.entries(n)) {
      const c = this.options.outputNewOnly ? "" : "__added";
      !(s in e) && !this.options.excludeKeys.includes(s) && (i[`${s}${c}`] = u, o -= 30, a = !1);
    }
    for (const [s, u] of Object.entries(e))
      if (s in n) {
        if (this.options.excludeKeys.includes(s))
          continue;
        o += 20;
        const c = n[s], f = this.diff(u, c);
        f.equal ? (this.options.full || this.options.outputKeys.includes(s)) && (i[s] = u) : (i[s] = f.result, a = !1), o += Math.min(20, Math.max(-10, f.score / 5));
      }
  ...
  findMatchingObject(e, n, i) {
    ...
    for (const [a, { item: s, index: u }] of Object.entries(
      ...
      if (a !== "__next") {
        const c = Math.abs(u - n);
        if (fe(e) === fe(s)) {
          const { score: f } = this.diff(e, s);
          (!o || f > o.score || f === o.score && c < o.indexDistance) && (o = { score: f, key: a, indexDistance: c });
        }
      }
    return o;
  }
  scalarize(e, n, i) {
    ...
    if (i) {
      ...
      for (let u = 0; u < e.length; u++) {
        ...
        if (this.isScalar(c))
          continue;
        const f = this.findMatchingObject(c, u, i);
        f && (!s[f.key] || f.score > s[f.key].score) && (s[f.key] = { score: f.score, index: u });
      }
    ...
    for (let s = 0; s < e.length; s++) {
      ...
      if (this.isScalar(u))
        ...
        const c = o[s] || "__$!SCALAR" + n.__next++;
        n[c] = { item: u, index: s }, a.push(c);
      }
    }
    return a;
  }
  ...
  arrayDiff(e, n) {
    ...
    let c = [], f = 0, d = !0;
    for (const [b, v, I, y, m] of u) {
      let h, O, S, G, K, q, Y, H;
      switch (b === "equal" || this.options.keysOnly && b === "replace" || (d = !1), b) {
        case "equal":
          for (h = v, G = I, S = v <= G; S ? h < G : h > G; S ? h++ : h--) {
            const R = o[h];
            if (this.isScalarized(R, i)) {
              ...
              N.equal ? this.options.full || this.options.keepUnchangedValues ? c.push([" ", P]) : c.push([" "]) : (c.push(["~", N.result]), d = !1);
            } else
              this.options.full || this.options.keepUnchangedValues ? c.push([" ", R]) : c.push([" "]);
            f += 10;
          }
          break;
        case "delete":
          for (h = v, q = I, K = v <= q; K ? h < q : h > q; K ? h++ : h--)
            c.push(["-", this.descalarize(o[h], i)]), f -= 5;
          break;
        case "insert":
          for (O = y, H = m, Y = y <= H; Y ? O < H : O > H; Y ? O++ : O--)
            c.push(["+", this.descalarize(s[O], a)]), f -= 5;
          break;
        case "replace":
          if (this.options.keysOnly) {
            let R, P;
            for (h = v, P = I, R = v <= P; R ? h < P : h > P; R ? h++ : h--) {
              const M = this.diff(
                this.descalarize(o[h], i),
                this.descalarize(s[h - v + y], a)
              );
              M.equal ? c.push([" "]) : (c.push(["~", M.result]), d = !1);
            }
          } else {
            let R, P, M, N;
            for (h = v, P = I, R = v <= P; R ? h < P : h > P; R ? h++ : h--)
              c.push(["-", this.descalarize(o[h], i)]), f -= 5;
            for (O = y, N = m, M = y <= N; M ? O < N : O > N; M ? O++ : O--)
              c.push(["+", this.descalarize(s[O], a)]), f -= 5;
          }
          break;
      }
    }
    return d || u.length === 0 ? (this.options.full ? c = e : c = void 0, f = 100) : f = Math.max(0, f), { score: f, result: c, equal: d };
  }
  diff(e, n) {
    const i = fe(e), o = fe(n);
    if (i === o)
...
function Vr(t, e, n = {}) {
  return n.precision !== void 0 && (t = de(t, n.precision), e = de(e, n.precision)), new Wr(n).diff(t, e).result;
}
async function Kr(t, e, n, i) {
  ...
  if (c.props) {
    ...
    for (const d in c.props)
      d.endsWith("__added") ? f.props[d.replace("__added", "")] = c.props[d] : d.endsWith("__deleted") ? f.props[d.replace("__deleted", "")] = void 0 : f.props[d] = c.props[d].__new;
  }
  return c.content && (f.content = u.content), c.type && (f.type = u.type), f;
}
function Ie(t) {
  return Ae().use(hr).stringify(t);
}
function vt(t) {
  return t.flatMap((e) => [e, ...vt(e.children)]);
}
async function Yr(t, e, n) {
  const i = [];
  if (e = vt(e), n.filter((s) => s.type !== "add").length !== e.length)
    throw new Error(
...
async function Xr(t, e) {
  const n = await t.blocksToMarkdownLossy(), i = {
    messages: "messages" in e ? e.messages : Zr({
      editor: t,
      markdown: n,
      userPrompt: e.prompt
    }),
  ...
  }), a = Jr(t.document, (f) => f.type === "paragraph" && Array.isArray(f.content) && f.content.length === 0), s = o.text.trim(), u = await Hr(n, s), c = await Yr(
    t,
    a,
    u
  );
...
function Jn(t) {
  const e = oe(), { children: n, ...i } = t, [o, a] = te(
    void 0
  ), [s, u] = te(e.document), { model: c, dataFormat: f, stream: d } = i, [b, v] = te("initial"), I = re(
    async (y) => {
      u(e.document), v("generating");
      let m;
      try {
        return f === "json" ? m = await ot.json.call(e, {
          model: c,
          stream: d,
          ...y
        }) : (y.functions && console.warn(
          "functions are not supported for markdown, ignoring them"
        ), m = await ot.markdown.call(e, { model: c, ...y })), v("done"), m;
      } catch (h) {
        v("initial"), u(void 0), console.error(h);
      }
    },
    [c, f, d, e]
  );
...
var Ct = {
  ...
  style: void 0,
  attr: void 0
}, at = $.createContext && /* @__PURE__ */ $.createContext(Ct), Qr = ["attr", "size", "title"];
function en(t, e) {
  if (t == null) return {};
  var n = tn(t, e), i, o;
...
function ge(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2 ? st(Object(n), !0).forEach(function(i) {
      rn(t, i, n[i]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : st(Object(n)).forEach(function(i) {
...
function rn(t, e, n) {
  return e = nn(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function nn(t) {
  var e = on(t, "string");
...
function U(t) {
  return (e) => /* @__PURE__ */ $.createElement(an, me({
    attr: ge({}, t.attr)
  }, e), xt(t.child));
}
function an(t) {
  var e = (n) => {
    var {
      ...
      size: o,
      title: a
    } = t, s = en(t, Qr), u = o || n.size || "1em", c;
    return n.className && (c = n.className), t.className && (c = (c ? c + " " : "") + t.className), /* @__PURE__ */ $.createElement("svg", me({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, n.attr, i, s, {
  ...
  return at !== void 0 ? /* @__PURE__ */ $.createElement(at.Consumer, null, (n) => e(n)) : e(Ct);
}
function sn(t) {
...
const gn = (t) => {
  const e = ut(), { onManualPromptSubmit: n, promptText: i, onPromptTextChange: o } = t, [a, s] = te(""), u = i || a, c = re(
    async (m) => {
      m.key === "Enter" && n(u);
    },
    [u, n]
    ...
    [o, s, i]
  ), d = Ee(() => ur(t.items, u), [u, t.items]), { selectedIndex: b, setSelectedIndex: v, handler: I } = nr(d, (m) => m.onItemClick()), y = re(
    (m) => {
      m.key === "Enter" ? d.length > 0 ? I(m) : c(m) : I(m);
    },
    [c, I, d.length]
  );
  return ct(() => {
    v(0);
  }, [u, v]), /* @__PURE__ */ x.jsxs("div", { className: "bn-combobox", children: [
    /* @__PURE__ */ x.jsx(e.Generic.Form.Root, { children: /* @__PURE__ */ x.jsx(
      e.Generic.Form.TextInput,
      {
        className: "bn-combobox-input",
        name: "ai-prompt",
        variant: "large",
        icon: /* @__PURE__ */ x.jsx(Pe, {}),
        value: u || "",
        autoFocus: !0,
    ...
    /* @__PURE__ */ x.jsx(
      e.SuggestionMenu.Root,
      {
        ...
        children: d.map((m, h) => /* @__PURE__ */ x.jsx(
  ...
  return [
    {
      ...
      icon: /* @__PURE__ */ x.jsx(lt, { size: 18 }),
      onItemClick: async () => {
        await e.callLLM({
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ x.jsx(un, { size: 18 }),
      onItemClick: async () => {
        await e.callLLM({
          prompt: "Summarize",
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ x.jsx(cn, { size: 18 }),
      onItemClick: async () => {
        await e.callLLM({
  ...
  return [
    {
      ...
      icon: /* @__PURE__ */ x.jsx(pn, { size: 18 }),
      onItemClick: async () => {
        await e.callLLM({
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ x.jsx(mn, { size: 18 }),
      onItemClick: async () => {
        await e.callLLM({
          prompt: "Fix spelling",
          // By default, LLM will be able to add / update / delete blocks. For "summarize", we only want to allow adding new blocks.
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ x.jsx(fn, { size: 18 }),
      onItemClick: (i) => {
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ x.jsx(ln, { size: 18 }),
      onItemClick: async () => {
        await e.callLLM({
          prompt: "Simplify",
          // By default, LLM will be able to add / update / delete blocks. For "summarize", we only want to allow adding new blocks.
  ...
  return [
    {
      ...
      icon: /* @__PURE__ */ x.jsx(dn, { size: 18 }),
      onItemClick: (i) => {
    ...
    // },
    {
      ...
      icon: /* @__PURE__ */ x.jsx(sn, { size: 18 }),
      onItemClick: () => {
...
const _n = (t) => {
  const e = oe(), [n, i] = te(""), o = wt(), a = Re(), { aiResponseStatus: s } = a, { items: u } = t, c = Ee(() => {
    let d = [];
    return u ? d = u(e, a, s) : s === "initial" ? d = e.getSelection() ? yn(e, a) : hn(e, a) : a.aiResponseStatus === "done" && (d = bn(e, a)), d.map((b) => ({
      ...b,
      onItemClick: () => {
        b.onItemClick(i);
      }
  ...
  return ct(() => {
    ...
    gn,
    {
      onManualPromptSubmit: t.onManualPromptSubmit || f,
      items: c,
      promptText: n,
...
function Xn(t) {
  ...
  return /* @__PURE__ */ x.jsx(x.Fragment, { children: t.aiMenu !== !1 && /* @__PURE__ */ x.jsx(kn, {}) });
}
const kn = () => {
  const t = oe(), e = Re();
  return /* @__PURE__ */ x.jsx(
...
const xn = new pt("AIBlockToolbarPlugin");
class ti extends dr {
  constructor() {
    super();
    L(this, "view");
...
const In = new pt("blocknote-ai-show-selection");
class ri {
  constructor() {
    L(this, "plugin");
    this.plugin = new ft({
...
export {
  ti as AIBlockToolbarProsemirrorPlugin,
  Cn as AIBlockToolbarView,
  ri as AIShowSelectionPlugin,
  Qn as AIToolbarButton,
  kt as BlockNoteAIContext,
  Jn as BlockNoteAIContextProvider,
  Xn as BlockNoteAIUI,
  xn as aiBlockToolbarPluginKey,
  Zn as createBlockNoteAIClient,
  ae as getAIDictionary,
  ei as getAISlashMenuItems,
  ni as locales,
  Re as useBlockNoteAIContext
};

...
>((props, ref) => {
  ...
  return (
    <div
      ...
      className={cn(
        "bg-popover text-popover-foreground z-50 box-border max-w-screen overflow-x-auto overflow-y-auto overscroll-x-none rounded-md p-1 shadow-md ring-1 ring-foreground/10",
        "grid",
        className,
      )}

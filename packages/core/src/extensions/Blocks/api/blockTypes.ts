...
> = {
  ...
  render: ContainsInlineContent extends true
    ? (block: () => Block<BSchema>, editor: BlockNoteEditor<BSchema>) => { dom: HTMLElement; contentDOM: HTMLElement }
    : (block: () => Block<BSchema>, editor: BlockNoteEditor<BSchema>) => { dom: HTMLElement };
};

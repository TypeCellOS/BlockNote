...
> extends EventEmitter<any> {
  ...
  constructor(editor: BlockNoteEditor<BSchema, I, S>) {
    ...
    this.plugin = new Plugin({
      ...
      props: {
        //STEP 6: the final thing is to listen to the simulated keydown event generated by the onClick of emoji option in slash menu
            ...
            view.dispatch(
              view.state.tr
                ...
                .setMeta(suggestionMenuPluginKey, {
                  ...
                  //and this finally opens the emojiMenu thru slashmenu option
                })
            );

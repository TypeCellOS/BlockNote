...
// Adapted from https://github.com/ProseMirror/prosemirror-dropcursor/blob/master/src/dropcursor.ts
...
class DropCursorView {
  ...
  dragover(event: DragEvent) {
    ...
    // Edited section - disables drop cursor if content being dragged comes from
    // the same editor instance that the drop cursor is for.
    let disabled = (event as any).editorDOM !== this.editorView.dom;

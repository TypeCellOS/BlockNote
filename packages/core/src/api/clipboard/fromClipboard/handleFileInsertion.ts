...
import { getBlockInfoNearPos, getNodeId } from "../../getBlockInfoFromPos.js";
    ...
    if (file) {
      ...
      if (event.type === "paste") {
        ...
        insertedBlockId = editor.transact((tr) => {
          const blockInfo = getBlockInfoNearPos(tr, pos.pos);
          const id = getNodeId(blockInfo.block.node, tr.doc);

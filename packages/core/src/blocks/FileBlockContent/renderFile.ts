...
import { FileBlockExtension } from "./fileBlockExtensions";
import { renderDefaultFile } from "./renderDefaultFile";
...
export const renderFile = (
  ...
  addFileButtonText.innerText = `Add ${
  ...
  if (
    ...
    addFileButtonIcon.appendChild(extensions[block.props.fileType].buttonIcon!);
  } else {

...
export const alertBlock = createBlockSpec(alertConfig, {
  render: (block, editor) => {
    const alert = document.createElement("div");
    Object.entries(alertStyles).forEach(([key, value]) => {
      alert.style[key as any] = value;
    });
    alert.style.backgroundColor = alertTypes[block.props.type].backgroundColor;
    ...
    Object.entries(inlineContentStyles).forEach(([key, value]) => {
      inlineContent.style[key as any] = value;
    });
...
export const inlineContentStyles = {
  flexGrow: "1",
};

export const bracketsParagraphConfig = {
...
export const bracketsParagraphBlock = createBlockSpec(bracketsParagraphConfig, {
  render: () => {

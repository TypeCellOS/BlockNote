...
> = {
  v1: [
    ...
    {
      id: "7be49b02-10ec-4a3d-b6ff-1ead154636aa",
      type: "paragraph",
    },
    {
  ...
  v2: [
    {
      ...
      content: [
        {
          type: "text",
          text: "Goal of document is to look at work ahead and give a status update on project planning in terms of budget and timeline.",
        },
      ],
    },
    {
    ...
    {
      id: "193cbfcd-e467-4377-83b6-2641d042e88d",
      type: "heading",
      props: {
        level: 2,
      },
    ...
    {
      id: "30c43793-835c-4ce0-b8d3-57748123c644",
      type: "bulletListItem",
      content: [
        {
          type: "text",
          text: "Spent March - May",
        },
      ],
      children: [
        {
          id: "256828ef-82d6-4750-8433-423c786b6602",
          type: "bulletListItem",
          content: [
            {
              type: "text",
              text: "Kevin: 35k out of 50k",
            },
          ],
        },
        {
          id: "75c50e05-8150-4152-a082-f2fe719b7e63",
          type: "bulletListItem",
          content: [
            {
              type: "text",
              text: "BlockNote:  22k out of 50k",
            },
          ],
        },
        {
          id: "d839357b-ab6a-4765-8040-5c72052fc574",
          type: "bulletListItem",
          content: [
            {
              type: "text",
              text: "Total: 57k out of 100k (60%)",
            },
          ],
        },
      ],
    ...
    {
      id: "7990fb3e-7031-482b-bd6b-c7e01bad3cb7",
      type: "paragraph",
    },
    {
      id: "2d0b7eea-2ce0-45d3-9d6c-9990cc043a79",
      type: "paragraph",
      content: [
        {
          type: "text",
    ...
    {
      id: "c79a9782-2dd9-40cf-8fd0-d2d8b6e3dab4",
      type: "paragraph",
      content: [
        {
          type: "text",
          text: "+ there's still 40% of budget remaining and currently identified open tasks (see below) should fit this budget (TBD)",
        },
      ],
    },
    {
      id: "c7d7bac7-d9e3-4170-be56-45c8053e9a37",
      type: "paragraph",
      content: [
        {
          type: "text",
          text: "- current roadblock (schema compatibility) is taking more time / resources",
        },
      ],
    },
    {
      id: "ecd97b07-682f-40d5-a69a-564117671b96",
      type: "paragraph",
      content: [
        {
          type: "text",
          text: '- without a working demo we / client has not been able to start the user-testing phase yet, during which unknown issues could pop up. Therefore, marked as "at risk"',
        },
      ],
    },
    {
  ...
  v3: [
    ...
    {
      id: "6e400e2c-3e9e-4334-886d-d9f41c59f720",
      type: "paragraph",
    },
    {
      id: "53aac82d-99ce-498e-8bc1-b932fe52ff1e",
      type: "paragraph",
      content: [
        {
          type: "text",
          text: "TODO: keep within budget?",
        },
      ],
    },
    {
  ...
  v4: [
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: "+ there's still 40% of budget remaining",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          text: "- without a working demo we / client has not been able to start the user-testing phase yet, during which unknown issues could pop up.",
        },
      ],
    },
    {
      id: "74a36180-92f0-4c7f-b079-24486d765f9f",
      type: "paragraph",
      content: [
        {
          type: "text",
          text: "+- Besides the schema compatibility roadblock, most of the identified work-items relate to Suggestions. We can re-scope to diffing / attributed versions and stay close to budget, after which we can revisit suggestions",
        },
      ],
    },
    {
  ...
  v5: [
    ...
    },
    {
      ...
      children: [
        {
          id: "74a40e6f-de52-4e2f-82aa-4811a6e7237b",
          type: "bulletListItem",
          content: [
            {
              type: "text",
              text: "note: excludes possible extra work for yhub migration",
            },
          ],
        },
      ],

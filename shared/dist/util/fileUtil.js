 ...
 */
export async function loadFileDataUrl(requireUrl, mimeType) {
    if (import.meta.env.NODE_ENV === "test") {
        ...
        return requireUrl.default;
    }
}
export async function loadFontDataUrl(requireUrl) {
...
export async function loadFileBuffer(requireUrl) {
    if (import.meta.env.NODE_ENV === "test") {
        ...
        // in browser, this is already a data url
        const dataUrl = requireUrl.default;

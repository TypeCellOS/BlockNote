...
<Callout type={"info"}>
    If you replace the Slash Menu component as well as [change the items in it](/docs/ui-components/slash-menu#changing-slash-menu-items), you no longer have to use the `DefaultReactSuggestionItem` type. The items can be any type you want, just make sure you use the same one for your component's props.
</Callout>

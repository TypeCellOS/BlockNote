...
<Callout type="warning" emoji="⚠️">
    Themes are only compatible with BlockNote's default Mantine UI and will not have any effect if [using other component libraries](/docs/advanced/component-libraries)
</Callout>

...
-   `autoDetectMarkdown`: Whether to auto-detect markdown in the clipboard and paste that as rich text. This will take priority over pasting html into the editor.

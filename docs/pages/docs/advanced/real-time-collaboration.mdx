...
- [Y-Sweet by Jamsocket](https://jamsocket.com/y-sweet) An open source Yjs sync engine with persistence to object storage. Self hostable or available serverless with Jamsocket, the platform for deploying sync engines.  

...
Grid Suggestion Menus offer the same additional features as the regular Suggestion Menus, see those [here](/docs/ui-components/suggestion-menus#additional-features).

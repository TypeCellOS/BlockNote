...
By default, BlockNote documents support different kind of blocks (paragraphs, headings, lists, etc.), inline content (text, links) and text styles (bold, italic, underline, etc.). See xxxx.
...
Learn how to create custom inline content for your BlockNote editor. Inline Content are elements that can be inserted inside a text block, such as links, mentions, tags, etc.

- [Learn how to create custom Inline Content for your BlockNote editor](/docs/custom-schemas/inline-content)

### Custom Styles

Learn how to create custom text styles for your BlockNote editor. Text Styles are properties that can be applied to a piece of text, such as bold, italic, underline, etc.

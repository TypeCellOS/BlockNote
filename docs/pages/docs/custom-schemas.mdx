...
## Creating a Custom LaTeX Equation Block

You can create a custom block to input and render LaTeX equations within the text editor. This block will allow users to type LaTeX code and have it rendered properly as mathematical notation within the document.

Here is an example of how to create a custom LaTeX equation block using `createReactBlockSpec`:
...
To see a full example of how to use this custom LaTeX equation block, check out the [LaTeX Block Example](https://github.com/TypeCellOS/BlockNote/tree/main/examples/06-custom-schema/latex-block).

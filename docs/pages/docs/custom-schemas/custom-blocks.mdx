...
The `PropSchema` specifies the props that the block supports. The props of a block is data that is associated with your Block, and can be used to customize the block's appearance or behavior.

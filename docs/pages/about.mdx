import {CTAButton} from "../components/CTAButton";import GitHubButton from 'react-github-btn';
...
<p className="nx-mt-6"><GitHubButton href="https://github.com/TypeCellOS/BlockNote" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star TypeCellOS/BlockNote on GitHub">Star</GitHubButton></p>
...
<div className={"mt-6"}>
    <CTAButton href={"mailto:youse@typecell.org"} variant={"small"}>Contact</CTAButton>
</div>
...
<p className="nx-mt-6"><GitHubButton href="https://github.com/sponsors/YousefED" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-heart" data-size="large" aria-label="Sponsor @YousefED on GitHub">Sponsor</GitHubButton></p>

  ...
  return (
    ...
    >
      ...
      <div className="perspective-1000 group relative w-full flex-1 lg:pt-16">
        ...
        <div className="relative transform overflow-hidden rounded-xl border border-stone-200 bg-white shadow-2xl transition-transform duration-500 group-hover:rotate-y-2">
          {children}
        </div>
      </div>
    </div>

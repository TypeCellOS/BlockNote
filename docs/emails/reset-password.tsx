...
export const ResetPassword = ({ name, url }: ResetPasswordProps) => {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>BlockNote - Reset your password</Preview>
        <Container style={container}>
          ...
          <Section>
            ...
            <Text style={text}>
              Someone recently requested a password reset for your BlockNote
              account. If this was you, you can reset your password by clicking
              the button below:
            </Text>

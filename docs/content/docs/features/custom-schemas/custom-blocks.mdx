...
You can then instantiate your editor with this custom schema, as explained on the [Custom Schemas](/docs/reference/editor/custom-schemas) page.
...
To fix this, it's recommended to implement a [command to insert your custom in the Slash Menu](/docs/react/styling-theming/components/suggestion-menus#changing-slash-menu-items), and [an item for it in the Block Type Select](/docs/react/styling-theming/components/formatting-toolbar#

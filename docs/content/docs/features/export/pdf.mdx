...
If you're using a [custom schema](/docs/reference/editor/custom-schemas) in your editor, or if you want to overwrite how default BlockNote elements are converted to PDF, you can pass your own `mappings`:

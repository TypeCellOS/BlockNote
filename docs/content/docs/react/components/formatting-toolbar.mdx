...
For the best behavior, add `interactive-widget=resizes-content` to your page's viewport meta tag — see [Mobile Support](/docs/features/mobile#viewport-setup) for the tag and what it changes.

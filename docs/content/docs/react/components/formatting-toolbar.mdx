...
description: Format selected text or use the mobile toolbar above the on-screen keyboard.
---
...
On touch devices, BlockNote shows the mobile Formatting Toolbar above the on-screen keyboard while it's open and the editor is focussed, rather than floating around the selected content. Open any of the examples above on a phone to see it.

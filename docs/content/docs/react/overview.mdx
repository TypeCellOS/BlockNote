...
{/* TODO: When hovering e.g.the `theme` prop for more info, the link is broken. */}
{/* TODO: The `theme` field also doesn't include all possible types. */}
<auto-type-table
...
{/* TODO: These links aren't quite right */}

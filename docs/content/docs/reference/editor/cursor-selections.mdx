...
- **[Manipulating Blocks](/docs/reference/editor/manipulating-blocks)** - Work with selected blocks
- **[Manipulating Inline Content](/docs/reference/editor/manipulating-inline-content)** - Format selected text

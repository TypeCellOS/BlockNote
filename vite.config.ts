...
export default defineConfig({
  ...
  fmt: {
    ...
    ignorePatterns: [
      ...
      "**/playwright-report/**",
      "**/blob-report/**",
      "packages/core/src/emoji-data/frimousse/*.json",
      "packages/core/scripts/emoji-data/search-overlays/slugs.json",
      "packages/core/scripts/emoji-data/search-overlays/tr.ts",
      "**/*.mdx",
      "pnpm-lock.yaml",
    ],
  },

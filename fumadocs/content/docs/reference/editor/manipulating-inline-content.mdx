...
description: BlockNoteEditor exposes a number of functions to interact with the currently selected content.
path: /docs/block-content
---

Explore how to interact with the currently selected content.

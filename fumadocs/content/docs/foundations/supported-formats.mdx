...
| **[PDF](/features/export/pdf)** (`@blocknote/xl-pdf-exporter`)    | ❌         | ✅         | ✅                   |
| **[DOCX](/features/export/docx)** (`@blocknote/xl-docx-exporter`) | ❌         | ✅         | ✅                   |
| **[ODT](/features/export/odt)** (`@blocknote/xl-odt-exporter`)    | ❌         | ✅         | ✅                   |

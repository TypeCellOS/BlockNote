      ...
      {[
        {
          title: "Summarize",
          label: "the document",
          action: "Create a short summary of the document",
        },
        {
          title: "Add action items",
          label: "to the document",
          action: "Add action items to the document",
        },
...
const AssistantMessage: FC = () => {
  // added to hide specific messages
  const isDocumentStateMessage = useAssistantState(
    ({ message }) =>
      message.parts.length > 0 &&
      message.parts[0].type === "tool-call" &&
      message.parts[0].toolName === "document-state",
  );

  if (isDocumentStateMessage) {
    return null;
  }
